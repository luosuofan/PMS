    ...
    <el-row :gutter="15">
      <el-col :md="6" :sm="12">
        <el-card shadow="never" class="monitor-count-card">
          ...
          <div class="monitor-count-card-num">79.8 k</div>
      ...
      <el-col :md="6" :sm="12">
        <el-card shadow="never" class="monitor-count-card">
          ...
          <div class="monitor-count-card-num">10.9 k</div>
      ...
      <el-col :md="6" :sm="12">
        <el-card shadow="never" class="monitor-count-card">
          ...
          <div class="monitor-count-card-num">926.0</div>
      ...
      <el-col :md="6" :sm="12">
        <el-card shadow="never" class="monitor-count-card">
          ...
          <div class="monitor-count-card-num">75.3 %</div>
      ...
      <el-col :lg="6">
        <el-row :gutter="15">
          <el-col :lg="24" :md="12" :sm="24">
            <el-card shadow="never" header="用户人数">
              <div class="monitor-online-num-card">
                ...
                <div class="monitor-online-num-text">用户总人数</div>
      ...
      <el-col :lg="8" :md="12">
        <el-card shadow="never" header="用户满意度">
          <div class="ele-cell" style="margin: 15px 0;">
            ...
            <h2 class="ele-cell-content ele-text-success ele-text-center">98%</h2>
          </div>
          <el-divider/>
          <div class="ele-cell" style="margin: 15px 0 12px 0;">
            <div class="ele-cell-content ele-text-center" style="font-size: 24px;">80</div>
            <div class="ele-cell-content ele-text-center">
            ...
            <h2 class="ele-cell-content ele-text-danger ele-text-center">5%</h2>
          </div>
        </el-card>
      </el-col>
      <el-col :lg="8" :md="12">
          ...
          <div class="ele-cell" style="padding: 34px 0;justify-content: center;">
            ...
            <div class="monitor-progress-legends" style="padding-left: 12px;">
              <div class="ele-text-small">
                <ele-dot :ripple="false" text="活跃率: 85%"/>
              </div>
              <div class="ele-text-small">
                <ele-dot type="success" :ripple="false" text="留存率: 90%"/>
              </div>
              <div class="ele-text-small">
                <ele-dot type="danger" :ripple="false" text="跳出率: 20%"/>
              </div>
            </div>
          </div>
        </el-card>
