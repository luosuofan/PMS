...
from application.repairreport import services
...
class DictDetailView(PermissionRequired, View):
    # 方法权限标识
    permission_required = ("sys:repairreport:detail",)
...
class DictAddView(PermissionRequired, View):
    # 方法权限标识
    permission_required = ("sys:repairreport:add",)
...
class DictUpdateView(PermissionRequired, View):
    # 方法权限标识
    permission_required = ('sys:repairreport:update',)
...
class DictDeleteView(PermissionRequired, View):
    # 方法权限标识
    permission_required = ('sys:repairreport:delete',)
