...
from application.supplier import services
...
class DictListView(PermissionRequired, View):
    # 方法权限标识
    permission_required = ("sys:supplier:list",)
...
class DictDetailView(PermissionRequired, View):
    # 方法权限标识
    permission_required = ("sys:supplier:detail",)
...
class DictUpdateView(PermissionRequired, View):
    # 方法权限标识
    permission_required = ('sys:supplier:update',)
