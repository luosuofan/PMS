...
from application.inspectreport import views

# 意见反馈模块路由
urlpatterns = [
    # 查询质检报表分页列表
    path('list', views.InspectreportListView.as_view()),
    # 添加质检报表
    path('add', views.InspectreportAddView.as_view()),
    # 查询质检报表详情
    path('detail/<int:Inspectreport_id>', views.InspectreportDetailView.as_view()),
    # 更新质检报表
